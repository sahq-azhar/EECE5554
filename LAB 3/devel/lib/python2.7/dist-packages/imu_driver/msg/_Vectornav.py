...
class Vectornav(genpy.Message):
  _md5sum = "9256685a578d2124906f486b85ab4572"
...
MSG: sensor_msgs/MagneticField
 ...
 float64[9] magnetic_field_covariance # Row major about x, y, z axes
  ...
  __slots__ = ['Header','IMU','MagField','raw_IMU']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.raw_IMU = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.raw_IMU = str[start:end]
      return self
