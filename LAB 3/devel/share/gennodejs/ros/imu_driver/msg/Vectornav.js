...
class Vectornav {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('raw_IMU')) {
        this.raw_IMU = initObj.raw_IMU
      }
      else {
        this.raw_IMU = '';
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [raw_IMU]
    bufferOffset = _serializer.string(obj.raw_IMU, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [raw_IMU]
    data.raw_IMU = _deserializer.string(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return '9256685a578d2124906f486b85ab4572';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.raw_IMU !== undefined) {
      resolved.raw_IMU = msg.raw_IMU;
    }
    else {
      resolved.raw_IMU = ''
    }
