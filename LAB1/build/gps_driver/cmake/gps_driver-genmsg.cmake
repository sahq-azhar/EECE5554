...
set(MSG_I_FLAGS "-Igps_driver:/home/saad/sahq1/src/gps_driver/msg;-Isensor_msgs:/opt/ros/melodic/share/sensor_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/saad/sahq1/src/gps_driver/msg/gps.msg" NAME_WE)
add_custom_target(_gps_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "gps_driver" "/home/saad/sahq1/src/gps_driver/msg/gps.msg" ""
)
...
_generate_msg_cpp(gps_driver
  "/home/saad/sahq1/src/gps_driver/msg/gps.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gps_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/gps_driver\")")
  # install generated code
  install(
